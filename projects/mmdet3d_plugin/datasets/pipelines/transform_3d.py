...
@PIPELINES.register_module()
class RescaleImageMultiViewImage(object):
    """Scale the images
    Args:
        scales
    """
    ...
    def __call__(self, results):
        """Call function to rescale the multi-view images in the pipeline
        Args:
            results (dict): Result dict from loading pipeline.
        Returns:
            dict: Updated result dict.
        ...
        scale = self.scale
        # TODO critical adopt behavior of PadImg, check with load multi view..
        ...
        results["img_shape"] = (y_size, x_size)
